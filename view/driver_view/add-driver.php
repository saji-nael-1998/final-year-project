                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="license" name="license" aria-describedby="emailHelp">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="licenceexpirydate" name="licenceexpirydate" aria-describedby="emailHelp">
